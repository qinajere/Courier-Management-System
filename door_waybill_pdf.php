...
// insert waybill records into database		
	$sql = "INSERT INTO waybill (waybill_no, consignor_name, consignor_phone, consignor_add, consignee_name, consignee_phone, consignee_add, description, weight, quantity, source, destination, service_type, rate, tax, total_charged, created_by, way_date, status, comment)
