...
<div class="col-md-8 col-md-offset-3 mydash">
                    <div class="panel panel-default new">
                        ...
                        <div class="panel-body">
                           <div class="col-md-12">
                                    <form role="form" action="view-man-rec.php"  method="post" name="frmShipment" target="_blank">

                                     <div class="form-group">
                                      <label class="mini-label color">ENTER DATE RECIEVED: </label>                                     
                                    </div>
                                    <hr>
                                    <div class="col-md-10">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group col-md-5 col-md-offset-1">
                                            <label>From:</label>
                                            <input name="fromdate" id="fromdate" readonly style="cursor: text;" onClick="ds_sh(this);" maxlength="15" type="TEXT" value="<?php echo date("Y/m/d") ?>"/>
                                        </div>
                                        <div class="form-group col-md-5">
                                            <label>To:</label>
                                            <input name="todate" id="todate" readonly style="cursor: text;" onClick="ds_sh(this);" maxlength="15" type="TEXT" value="<?php echo date("Y/m/d") ?>"/>
                                        </div>
