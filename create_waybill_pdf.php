...
// getting rate, tax and total
		
		
	//gets the category to get the rate
...
// for weights greater than 10 add 200 to each addition kg
if ($weight >= 10.1)
       {
...
// insert waybill records into database		
	$sql = "INSERT INTO waybill (waybill_no, consignor_name, consignor_phone, consignor_add, consignee_name, consignee_phone, consignee_add, description, weight, quantity, source, destination, service_type, rate, tax, total_charged, created_by, way_date, way_time, status, comment)
	
			VALUES('$consignmentNo', '$consignername', '$consignerphone','$consigneraddress', '$consigneename', '$consigneephone','$consigneeaddress','$description','$weight','$quantity','$source','$destination','$servicetype','$rate','$vat','$total_charged', '$emp', '$consignmentdate','$consignmenttime','at source', 'active')";
...
$sql_3= "UPDATE seq_note
	...
	$sql4 = "INSERT INTO transactions (id, transaction_date, consigner_name, type, details, debit, office, created_by ) values ('NULL','$consignmentdate','$consignername', 'WAYBILL','$consignmentNo',$rate, '$source', '$emp' )";
dbQuery($sql4);
