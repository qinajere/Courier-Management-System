     ...
     <div class="col-md-8 col-md-offset-3 mydash">
                    <div class="panel panel-default new">
                        <div class="panel-heading new-panel">
                          ...
                          DOOR TO DOOR CONSIGNMENT
                        </label>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                           <div class="col-md-12">
                                    <form role="form" action="door_waybill_pdf.php?" method="post" name="frmShipment" class="register" target="_blank">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="text" name="servicetype"  class="mini-label2" readonly value="door to door"/>
                                    </div>
                                      ...
                                      <div class="col-md-6 div-space">
                                        ...
                                        <div class="col-md-6">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <select class="form-control in-line" name="category" id="category" onChange="total1();">
                                              <option selected="selected" value="within city">within city</option>
        ...
        <!--   <form action="door_waybill_pdf.php?" method="post" name="frmShipment" class="register" target="_blank" > 
         <h1>DOOR TO DOOR CONSIGNMENT</h1>
            <p>&nbsp;</p>
            <p> <label>DATE: </label>
                <input type="text" name="consignmentdate" style="border: solid 0px" readonly value="<?php echo date("Y/m/d")?>"/>
                
                <label> SERVICE TYPE: </label>
                <input type="text" name="servicetype" style="border: solid 0px" readonly value="door to door"/>  
            ...
            <fieldset class="row1">
              <legend>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;consigner: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;consignee: </legend> 
                <p>
                    ...
                    <input type="text" name="consignername" id="consignername"/> 
                    <label>Name:
                    </label>
            ...
            <fieldset class="row2">
                ...
                <p>
                    ...
                    <input type="text" id="weight" name="weight" value="0.00"  onChange="total1();" />
                </p>
                <p>
                    <label>Quantity:
                    </label>
            ...
            <fieldset class="row3">
                ...
                <p>
                    <label>Category:</label>
                    <select name="category" id="category" onChange="total1();">
                       <option selected="selected" value="within city">within city</option>
                        <option value="outside city">outside city</option>
