...
$sql = "SELECT distinct category.id, category.category FROM category, rate_table WHERE ((category.id= rate_table.category_id) AND (rate_table.service_id = 2) AND rate_table.type = 'within city' )";
...
<div class="col-md-8 col-md-offset-3 mydash">
                    <div class="panel panel-default new">
                        <div class="panel-heading new-panel">
                          ...
                          EDIT DOOR TO DOOR WITHIN CITY RATES
                        </label>
                        </div>
                        <!-- /.panel-heading -->
