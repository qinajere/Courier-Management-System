...
$sql_2 = " SELECT recievers.name, recievers.id_no, recievers.waybill_no, recievers.rec_date, waybill.consignor_name, waybill.consignee_name, waybill.description FROM recievers, waybill 
              WHERE (recievers.waybill_no = waybill.waybill_no) 
			  AND
			  waybill.destination = '$off'
			  AND
             ( recievers.rec_date BETWEEN '$fromdate' AND '$todate')
		...
		if ($source != "All")
		{
			$sql_2.= "  AND waybill.source = '$source' ";
		}
...
$pdf->SetTitle("Recievers report_pdf",false);
...
$pdf->SetY(30);
$pdf->Cell(270, 20,'RECIEVERS REPORT',0 ,1 ,"C");
...
$pdf->Cell(80, 10,'BRANCH:'.$destination,0 ,0 ,"C");

$pdf->Cell(20, 10,'DATE:   From: '.$fromdate,0 ,0 ,"C");
$pdf->Cell(60, 10,'To: '.$todate,0 ,0 ,"C");
$pdf->Cell(30, 10,'Source: '.$source,0 ,0 ,"C");
