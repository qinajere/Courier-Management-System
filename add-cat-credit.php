...
$sql = "SELECT category_id FROM `rate_table` WHERE service_id = 3 GROUP BY category_id ORDER BY category_id DESC limit 1";
	...
	<div class="col-md-8 col-md-offset-3 mydash">
                    <div class="panel panel-default new">
                        <div class="panel-heading new-panel">
                          ...
                          ADD NEW CATEGORY TO CREDIT RATES
                        </label>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                           <div class="col-md-12">
                                    <form role="form" name="frmShipment" method="post"  action="new-category-credit.php">
