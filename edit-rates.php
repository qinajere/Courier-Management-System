...
$sql = "SELECT distinct category.id, category.category FROM category, rate_table WHERE ((category.id= rate_table.category_id) AND (rate_table.service_id = 1))";
                 ...
                 <script>
							...
							if (value === "0")
                               ...
                               $("#search_results").html("please select a category");
                                ...
                                $.post('results.php',{value:value}, function(data){
