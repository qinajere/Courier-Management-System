...
$sql = "SELECT driver_id, driver_name, phone, reg_date
        FROM driver
                                    ...
                                    <tbody>
                                      ...
                                      ?>
                                        <tr onMouseOver="this.bgColor='#EDEDED';" onMouseOut="this.bgColor='#FFFFFF';" bgcolor="#FFFFFF">
                                            ...
                                            <td align="center"><a href="edit-driver.php?did=<?php echo $driver_id ?>" title="Edit">
                                                <img src="images/edit_icon.gif" border="0" height="20" width="20"></a>
                                            </td>
                                            <td align="center">
                                                <a href="process.php?did=<?php echo $driver_id ?>&amp;action=delete-driver" onClick="return are_u_sure();" title="Delete"><span class="glyphicon glyphicon-trash"></span></a>
                                            </td>
                                        </tr>
                                         <?php
                                          }//while
