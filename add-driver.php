...
if(isset($_POST['drivername']))
{
 ...
 $succesfull = add_new_driver( $_POST['drivername'], $_POST['phone'], $_POST['regdate']);
                    ...
                    <div class="panel panel-default new">
                        ...
                        <div class="panel-body">
                           <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                      <label class="mini-label color">DRIVER DETAILS: </label>                                     
                                    </div>
                                    <hr>
                                    <div class="col-md-6 div-space">
                                        <div class="form-group">
                                            <label>Name:</label>
                                            <input type="text" name="drivername" id="drivername" class="form-control in-line2">
                                        </div>
                                        <div class="form-group">
                                           <label>Phone:</label>
                                        ...
                                        <div class="form-group">
                                        <button type="submit" name="Submit" class="btn btn-success submit-space3" onClick="MM_validateForm('drivername','','R','phone','','R');return document.MM_returnValue">
                                        ADD DRIVER  &raquo;</button>
