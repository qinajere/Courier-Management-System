...
if(isset($_POST['firstname']))
{
 ...
 $succesfull = add_new_clerk( $_POST['firstname'], $_POST['lastname'], $_POST['username'], $_POST['phone'], $_POST['address'], $_POST['email'], $_POST['password'],$_POST['regdate'],$_POST['office'] );
                    ...
                    <div class="panel panel-default new">
                        ...
                        <div class="panel-body">
                           <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                      <label class="mini-label color">CLERK DETAILS: </label>                                     
                                    </div>
                                    <hr>
                                    <div class="col-md-6 div-space">
                                      ...
                                      <div class="col-md-6 div-space">
                                        ...
                                        <button type="submit" name="Submit" class="btn btn-success submit-space2" onClick="MM_validateForm('firstname','','R','lastname','','R','username','','R','phone','','R','address','','R','email','','R','password','','R','confirmpassword','','R');return document.MM_returnValue">
                                          ADD CLERK  &raquo;</button>
                                    </form>
                                </div>
                        </div>
                        <!-- /.panel-body -->
